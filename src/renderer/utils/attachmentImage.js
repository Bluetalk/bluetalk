...
export function resolveImageMime(fileType, fileName, fileData) {
...
export function isImageAttachment(fileType, fileName, fileData) {
  return Boolean(resolveImageMime(fileType, fileName, fileData));
}

export function normalizeAttachmentFileType(fileName, fileType, fileData) {
