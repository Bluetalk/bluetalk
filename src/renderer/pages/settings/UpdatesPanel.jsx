      ...
      <div className="card">
        <div className="toggle-row">
          <div className="toggle-row-info">
            ...
            <span>Sucht im Hintergrund nach neuen Versionen</span>
          </div>
        ...
        <div className="toggle-row">
          <div className="toggle-row-info">
            <span>Automatisch laden</span>
            <span>Lädt den Installer, sobald ein Update gefunden wird</span>
          </div>
          <label className="toggle">
            <input
              type="checkbox"
          ...
          <div className="card-row" style={{ alignItems: 'flex-start' }}>
            <div style={{ minWidth: 0 }}>
              <div className="font-medium" style={{ fontSize: 13.5 }}>
                BlueTalk {updaterState?.currentVersion || APP_VERSION}
              </div>
              <p className="text-sm text-muted" style={{ marginTop: 4 }}>
                {updaterState?.message || 'Manuell prüfen oder im Hintergrund suchen lassen.'}
              </p>
            </div>
